...
function GerenciarPlantaFloracao() {
  ...
  const UrlGetList = "http://192.168.0.24:8080/planta/ListarPlantasFloracao"
  ...
  const getLista = async () => {
    try {
      ...
      // Filtrar apenas plantas na fase de floração
      const plantasFloracao = data.filter(planta => planta.ciclo.ciclo === 'FLORACAO');
      setListAll(plantasFloracao);
    } catch (error) {
